...
| Gemini                    | VS Code extension settings (`geminicodeassist.*`)       | [.vscode/settings.default.jsonc](../../.vscode/settings.default.jsonc), [.devcontainer/devcontainer.json](../../.devcontainer/devcontainer.json)                                                                                                                                                                                                   | VS Code workspace + devcontainer customization settings     | Use extension-supported keys such as `geminicodeassist.agentYoloMode` and context-exclusion settings.                                       |
