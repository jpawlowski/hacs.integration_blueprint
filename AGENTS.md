...
- After significant functional changes (new features, behavior changes, API/coordinator/entity logic changes), always bump integration version in `custom_components/ha_integration_domain/manifest.json`.
